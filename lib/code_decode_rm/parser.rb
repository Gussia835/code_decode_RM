module CodeDecodeRM
  class Parser
    ...
    def parse_line(input)
      ...
      when INSTRUCTION_REGEX[:stop]   then parse_stop($1, $2)
    end

    #нормализация регистровой машины
